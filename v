...
DDEESSCCRRIIPPTTIIOONN
       ...
       ----ssoorrtt=_W_O_R_D
              sort according to WORD: general-numeric --gg, human-numeric --hh, month  --MM,  numeric
              --nn, random --RR, version --VV
       ...
       --TT, ----tteemmppoorraarryy--ddiirreeccttoorryy=_D_I_R
              use  DIR  for temporaries, not $TMPDIR or _/_t_m_p; multiple options specify multiple
              directories
       ...
       --uu, ----uunniiqquuee
              with --cc, check for strict ordering; without --cc, output only the first of an equal
              run
       ...
       defaults  to  the  line's end.  If neither --tt nor --bb is in effect, characters in a field
       ...
       that key.  If no key is given, use the entire line as the key.  Use ----ddeebbuugg to  diagnose
       incorrect key usage.
...
GNU coreutils 8.26                       February 2017                                  SORT(1)
