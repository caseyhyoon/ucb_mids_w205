...
- project-2-caseyhyoon
  - Project_2.ipynb (report with command line script and pyspark code)
  - README.md		(editted with Github repo description)
  - assessment-attempts-20180128-121051-nested.json (json dataset)
  - docker-compose.yml  (yml file)
  - history.txt		(console history)
